...
class FyndiqMerchantBackofficeControllers {
    public static function main($module) {
        ...
        $output .= FyndiqMerchantBackofficeControllers::handle_authentication($module);
        $output .= FyndiqMerchantBackofficeControllers::handle_disconnect($module);
        $output .= FyndiqMerchantBackofficeControllers::handle_products($module);

        if (!FyndiqMerchantBackofficeControllers::check_api_connection($module)) {
    ...
    private static function check_api_connection($module) {
        return (
